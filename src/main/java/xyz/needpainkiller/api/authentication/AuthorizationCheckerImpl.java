...
public class AuthorizationCheckerImpl implements AuthorizationChecker {
    ...
    public AuthorizationDecision check(Supplier<Authentication> authenticationSupplier, RequestAuthorizationContext context) throws TokenValidFailedException, ApiException {
        ...
        try {
            ...
            List<ApiEntity> publicApiList = authorizationServiceImpl.selectPublicApiList();
            ...
            if (isPublicApi) {
             ...
             requestApi = authorizationServiceImpl.selectNonPublicApiList().stream()
            ...
            ArrayList<Role> roleList = new ArrayList<>(authorizationServiceImpl.selectRoleListByApiPk(requestApi.getId()));
            if (roleList.isEmpty()) {
            ...
            ArrayList<RoleEntity> authorities = new ArrayList<>(securityUser.getRoleList());
