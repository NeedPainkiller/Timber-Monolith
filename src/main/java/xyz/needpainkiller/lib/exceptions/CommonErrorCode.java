...
public enum CommonErrorCode implements ErrorCode {
    ...
    RPA_JOB_SCHEDULE_NAME_EMPTY(HttpStatus.BAD_REQUEST, "요청 Job 의 이름이 확인되지 않음"),
    RPA_JOB_SCHEDULE_NOT_EXIST(HttpStatus.NOT_FOUND, "존재하지 않는 Job 스케쥴"),
    RPA_JOB_SCHEDULE_ALREADY_EXIST(HttpStatus.BAD_REQUEST, "이미 등록된 Job 스케쥴"),
    RPA_JOB_SCHEDULE_ALREADY_RUNNING(HttpStatus.BAD_REQUEST, "이미 수행중인 Job 스케쥴"),
    RPA_JOB_SCHEDULE_ALREADY_PAUSED(HttpStatus.BAD_REQUEST, "이미 중단된 Job 스케쥴"),
    RPA_JOB_SCHEDULE_CRON_INVALID(HttpStatus.BAD_REQUEST, "인식되지 않는 CRON 문법"),
    RPA_JOB_SCHEDULE_TYPE_NOT_SUPPORT(HttpStatus.BAD_REQUEST, "스케쥴링이 지원되지 않는 Service"),
    RPA_JOB_SCHEDULE_NOT_YOU_OWN(HttpStatus.FORBIDDEN, "스케쥴 관련 정보는 작성자 본인 또는 관리자만 조회 가능함"),
